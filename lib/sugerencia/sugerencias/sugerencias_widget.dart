...
class _SugerenciasWidgetState extends State<SugerenciasWidget> {
  ...
  void initState() {
    ...
    _model.txtSugerenciaController ??=
        TextEditingController(text: widget.sugerencia);
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.txtSugerenciaController,
                          focusNode: _model.txtSugerenciaFocusNode,
                          autofocus: true,
                          obscureText: false,
                          ...
                          validator: _model.txtSugerenciaControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        await launchUrl(Uri(
                            scheme: 'mailto',
                            path: 'sistemas.laempanada@gmail.com',
                            query: {
                              'subject':
                                  'Sugerencia Aplicación La Empanada Alajauelita',
                              'body': widget.sugerencia!,
                            }
                                .entries
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'El correo se envio exitosamente a equipo de soporte plataformas!',
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                            ...
                            duration: Duration(milliseconds: 4850),

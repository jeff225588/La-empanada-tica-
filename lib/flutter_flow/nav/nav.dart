...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/productosEditarProducto',
          builder: (context, params) => ProductosEditarProductoWidget(),
        ),
        FFRoute(
          name: 'productosNuevoProducto',
          path: '/productosNuevoProducto',
          builder: (context, params) => ProductosNuevoProductoWidget(),
        ),
        FFRoute(
          name: 'admindeusuarios',
          path: '/admindeusuarios',
          builder: (context, params) => AdmindeusuariosWidget(),
        ),
        FFRoute(
          name: 'editarusuario',
          path: '/editarusuario',
          builder: (context, params) => EditarusuarioWidget(
            ...
            namerol: params.getParam('namerol', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'productosNuevaUnidad',
          path: '/productosNuevaUnidad',

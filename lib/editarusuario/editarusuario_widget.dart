...
import 'editarusuario_model.dart';
export 'editarusuario_model.dart';
...
class _EditarusuarioWidgetState extends State<EditarusuarioWidget> {
  ...
  void initState() {
    ...
    _model.textController3 ??= TextEditingController(text: widget.namerol);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> editarusuarioUserRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editarusuarioUserRecord = editarusuarioUserRecordList.isNotEmpty
            ? editarusuarioUserRecordList.first
            : null;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          await editarusuarioUserRecord!.reference
                              .update(createUserRecordData(
                            displayName: _model.textController1.text,
                            email: _model.textController2.text,
                            rol: _model.textController3.text,
                          ));
                        },
                        text: 'Actualizar',

...
import 'editar_lista_de_envio_en_proceso_model.dart';
export 'editar_lista_de_envio_en_proceso_model.dart';

class EditarListaDeEnvioEnProcesoWidget extends StatefulWidget {
  const EditarListaDeEnvioEnProcesoWidget({
    Key? key,
  ...
  @override
  _EditarListaDeEnvioEnProcesoWidgetState createState() =>
      _EditarListaDeEnvioEnProcesoWidgetState();
}

class _EditarListaDeEnvioEnProcesoWidgetState
    extends State<EditarListaDeEnvioEnProcesoWidget> {
  late EditarListaDeEnvioEnProcesoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarListaDeEnvioEnProcesoModel());
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    ...
                                    onChanged: (val) => setState(() => _model
                                            .dropDownSeleccionarSucursalValue =
                                        val),
                                    width: 300.0,
                                    height: 50.0,
